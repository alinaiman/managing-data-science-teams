...
**Key insight:** Moving from IC to management is not a promotion. It is a career change.
...
|---|---|---|
| **Scope** | Completes assigned tasks | Identifies the right problems |
| **Autonomy** | Needs direction | Operates independently |
| **Ambiguity** | Struggles without clear requirements | Thrives in undefined spaces |
...
- **Round 1 (10 min):** Partner A gives SBI feedback. Partner B receives in character. Then 2 min pair debrief.
- **Round 2 (10 min):** Swap roles. New scenario or continue.
...
- Giver: Use SBI structure. Be specific.
...
- Did anyone find positive feedback harder than constructive?

**From mock calibration:**
