...
|---|---|---|
| **Entry** | Analyst | — |
| **Mid** | Senior Analyst | Team Lead |
| **Senior** | Staff Analyst | Manager |
...
**Senior = three dimensions:**

| Dimension | Junior | Senior |
|---|---|---|
| **Scope of impact** | Completes assigned tasks well | Identifies and solves the right problems |
...
| **Trigger** | Proactive — for anyone who wants to grow | Reactive — for underperformance |
...
| **B** — Behavior | What you observed (factual, specific) | "...when you presented the retention analysis without confidence intervals..." |
| **I** — Impact | The effect it had | "...the VP of Product questioned our methodology and we lost credibility for the rest of the meeting." |
...
- Prevents grade inflation (every manager thinks their people are above average)
- Ensures fairness across teams (Manager A's "meets expectations" = Manager B's)
...
3. Group discusses and adjusts ratings where needed
4. HR/leader facilitates and ensures consistency
...
1. **Role & Level Context** — What is this person's role and what's expected at their level?
2. **Key Accomplishments** — 3-5 with quantified business impact
3. **Growth Trajectory** — How have they grown this period?
...
| | Bad | Good |
|---|---|---|
| **Accomplishment** | "Built dashboards for the marketing team" | "Built the marketing attribution dashboard that identified $800K in misallocated spend, leading to a 14% improvement in CAC" |
...
- "Am I managing them out, or genuinely trying to help them improve?"
...
- Lead with curiosity, not conclusions. You might not know the full story.
...
Write a PGP — either for yourself or for a fictional direct report in your case context.
...
## Activity: Write a Calibration Summary
...
You've hired your team. You're growing them. Now they need **tools and partnerships** to do their work.
